...
const policies: Record<string, { title: string; icon: any; content: string[] }> = {
  'privacy-policy': {
    ...
    icon: ShieldAlert,
    content: [
      'At Suta & Stitch, accessible from sutastitch.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Suta & Stitch and how we use it.',
      'We do not collect credit card details or bank account information since all transactions on Suta & Stitch are processed via Cash on Delivery (COD). We only collect basic shipping information (Full Name, Address, Phone Numbers) to fulfill your orders.',
      ...
      'We retain your shipping details in our database to manage orders, process cancellations/refunds, and identify return abuse. If you wish to have your shipping details deleted from our database, please contact support@sutastitch.com.'
    ],
  },
  'terms-conditions': {
    ...
    icon: FileText,
    content: [
      'These terms and conditions outline the rules and regulations for the use of Suta & Stitch\'s Website.',
      'By placing an order on this website, we assume you accept these terms and conditions. Do not continue to use Suta & Stitch if you do not agree to take all of the terms and conditions stated on this page.',
      ...
      'In no event shall Suta & Stitch, nor any of its officers, directors, and employees, be held liable for anything arising out of or in any way connected with your use of this website.'
    ],
  },
  'shipping-policy': {
  ...
  'refund-policy': {
    ...
    content: [
      ...
      'To initiate a return, please contact our support team on WhatsApp at +91 90634 54476 or email us at support@sutastitch.com within 7 days of receiving the package. You will need to provide your Order Number and proof of damage (photos/videos).',
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm">
            ...
            <div className="mt-8 border-t border-slate-100 pt-6 text-center text-xs text-slate-400">
              ...
              <a href="mailto:support@sutastitch.com" className="font-bold text-blue-600 hover:underline">
                support@sutastitch.com
              </a>
            </div>
          </div>
